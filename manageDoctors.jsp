...
%>
	...
	<section>
			<h2 align="center"><font><strong>Manage Doctors</strong></font></h2>
			...
			<th Style="text-align:center"><b>HospitalId</b></th>
			...
			<td><%=db.rs.getString("dName") %> </td>
				...
				<td>
					<form action="deleteDoctor" method="post">
						...
						<input type = "hidden" name="id" value="<%=db.rs.getString("dName") %>">
